# Generated by Django 5.1.7 on 2025-04-12 12:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'post'], name='accounts_li_user_id_49bbd3_idx'), models.Index(fields=['user', 'comment'], name='accounts_li_user_id_8838f8_idx')],
